...
> **Note (personal fork)**: The original execution example above had a truncated `--manifest` flag on the dispatch command (`clawtasks_v1.js` instead of `clawtasks_v1.json`). Fixed above.
